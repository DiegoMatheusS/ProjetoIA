...
def build_result(raw, forced_category=None):
    ...
    return {
        ...
        "marketplace": {
            ...
            "browserlessProxy": os.getenv("BROWSERLESS_PROXY", "residential") if os.getenv("BROWSERLESS_TOKEN", "").strip() else None,
            "browserlessPais": os.getenv("BROWSERLESS_PROXY_COUNTRY", "BR") if os.getenv("BROWSERLESS_TOKEN", "").strip() else None,
        },
        "fonte": raw.get("source"),
        "erro": result_error,
    }
