...
def _analyze_capture_sync(payload: CaptureAnalyzeRequest) -> dict[str, Any]:
    ...
    result["servicoProdutoIa"] = {"versao": "14.6-railway", "modo": "CAPTURA_LOCAL_HTTP_API"}
    return result


@app.get("/health", response_model=HealthResponse)
def health() -> HealthResponse:
    return HealthResponse(ok=True, service="criabyte-produto-ia", version="14.6-railway")
